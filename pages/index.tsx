...
const MEMBERSHIP_NFT_CONTRACT_ADDRESS =
  "0x2549ff20ef9755538e4fc0bd3d02cc5cff5f59b1";
const MEMBERSHIP_NFT_TOKEN_ID = "1";
const MEMBERSHIP_NFT_TOKEN_COUNT = 1;
const OPENSEA_LINK =
  "https://testnets.opensea.io/assets/mumbai/0x2549ff20ef9755538e4fc0bd3d02cc5cff5f59b1/1";
...
const Home: NextPage = () => {
  ...
  return (
    <Container>
      <Head>
        <title>SavePantherNFT membership gated content</title>
      ...
      <Center flexDirection="column">
        <Heading>SavePanther NFT Member Only Lounge</Heading>
        <Text>
          You need to own SavePanther NFT in order to get access to the lounge
          webpage.
        </Text>
      ...
      <Box mt={20} textAlign="center">
        {account ? (
          ...
          <Button onClick={() => activate(injectedConnector)}>
            Connect Wallet (Matic Mumbai only)
          </Button>
        )}
      </Box>
      ...
      {hasMembershipAccess ? (
        <Center mt={8}>
          <Text textAlign="center">
            ...
            invite link{" "}
            <Link color="blue" href="https://discord.com/channels/939220138924834857/939221461749604382" isExternal>
            https://discord.com/channels/939220138924834857/939221461749604382
            </Link>
          </Text>
        </Center>
      ) : null}
